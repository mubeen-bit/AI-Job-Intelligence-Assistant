...
Requirements
5+ years of experience with proficiency in back-end development using Java EE technologies (e.g. Java language, application servers, servlet containers, JMS, JPA, etc.).
...
---
Metadata: ID=1209, Role=Software Engineer